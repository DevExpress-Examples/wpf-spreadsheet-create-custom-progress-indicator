...
Namespace WpfSpreadsheetProgressSample
    ...
    Public Partial Class MainWindow
        ...
        Public Sub New()
            ...
            Me.spreadsheetControl1.ReplaceService(Of IProgressIndicationService)(Me)
        End Sub
        ...
        Private Sub Begin(ByVal displayName As String, ByVal minProgress As Integer, ByVal maxProgress As Integer, ByVal currentProgress As Integer) Implements IProgressIndicationService.Begin
            ...
            savedCancellationTokenProvider = Me.spreadsheetControl1.ReplaceService(Of ICancellationTokenProvider)(New CancellationTokenProvider(cancellationTokenSource.Token))
        ...
        Private Sub [End]() Implements IProgressIndicationService.End
            ...
            Me.spreadsheetControl1.ReplaceService(savedCancellationTokenProvider)
            Me.spreadsheetControl1.UpdateCommandUI()
